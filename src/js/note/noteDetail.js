    ...
    methods: {
        initLayui: function (id,UserId,UserName,CompanyName,DptName) {
            ...
            layui.use(['element', 'form', 'table'], function () {
                ...
                _this.getNoteDetail(id,UserId,UserName,CompanyName,DptName,function(resultUser){
                    var CompanyIds=[];
                    var DptIds=[];
                    var JobIds=[];
                    var EmployeeIds=[];
        ...
        getNoteDetail: function (id,UserId,UserName,CompanyName,DptName,callback) {
            var _this = this;
            layer_load();
