...
var data_col = [
    [{
        ...
        },
        {
            ...
            templet: function(d) {
                if (d.bgStatus == 2) {
                    return "<span class='text-span'>启用</span>";
                } else {
                    return "<span class='text-del'>停用</span>";
                }
            }
        },
        {
        ...
        },
        {
            title: '操作',
            templet: function(d) {
                return getBtnHtml(d.isSystem, d.bgStatus);
            },
            width: 140
        }
    ]
...
layui.config({
    ...
    layform.on('submit(formDemo)', function(laydata) {
        ...
        if (laydata.field.Id == "") {
            ...
            Serv.Post('gc/Budget/add', {
                budget: laydata.field
            }, function(response) {
                if (response.code == "00") {
                    initTable(initTable);
                    Serv.Post('gc/budget/get', {
